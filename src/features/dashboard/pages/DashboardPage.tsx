          ...
          <div className="lg:col-span-1">
            ...
            <div className="mt-8 bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-slate-100 dark:border-slate-700">
              ...
              <div className="space-y-4">
                {[
                  { name: 'Pago Renta',          date: 'Hoy',  amount: '-$1.200.000',  positive: false },
                  { name: 'Ventas del Almuerzos', date: 'Ayer', amount: '+$500.000',   positive: true  },
                  { name: 'Ventas de Helados',    date: 'Ayer', amount: '+80.000',     positive: true  },
                ].map((item, i) => (
                  <div key={i} className="flex justify-between items-center text-sm">
                    ...
                    <span className={`font-medium ${item.positive ? 'text-green-600' : 'text-red-400'}`}>
                      {item.amount}
                    </span>
                  </div>
                ))}
